...
<div class="max-w-4xl">
    <div class="mb-6">
        <h2 class="text-2xl font-bold text-slate-900 mb-1">Agregar Nuevo Comercio</h2>
        <p class="text-slate-600">Complete los datos del comercio</p>
    </div>
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="DSC_DIRECCION" 
                              rows="3"
                              class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 @error('DSC_DIRECCION') border-red-500 @enderror">{{ old('DSC_DIRECCION') }}</textarea>
                    @error('DSC_DIRECCION')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
