        ...
        <div class="container mx-auto px-4 py-4">
            <div class="flex items-center justify-between">
                ...
                <nav class="hidden md:flex gap-6">
                    <a href="#" class="text-slate-600 hover:text-blue-600 transition">Inicio</a>
            ...
            <nav class="flex" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    <li class="inline-flex items-center">
                        <a href="#" class="text-slate-600 hover:text-blue-600">Inicio</a>
                    </li>
                </ol>
            </nav>
        </div>
    ...
    <div class="relative overflow-hidden bg-slate-900 h-[500px]" id="heroSlider">
        <div class="slide active absolute inset-0 transition-opacity duration-500">
            <img src="https://images.unsplash.com/photo-1464854860390-e95991b46441?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1080" 
                 alt="Descubre los Mejores Negocios" 
            ...
            <div class="absolute inset-0 flex items-center">
                <div class="container mx-auto px-4">
                    <div class="max-w-2xl text-white">
                        ...
                        <p class="text-white/90 text-xl mb-6">Explora miles de comercios locales y encuentra exactamente lo que buscas</p>
        ...
        <div class="slide absolute inset-0 transition-opacity duration-500 opacity-0">
            <img src="https://images.unsplash.com/photo-1690648518721-801b5e290844?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1080" 
                 alt="Productos y Servicios de Calidad" 
                 class="w-full h-full object-cover">
            <div class="absolute inset-0 bg-gradient-to-r from-slate-900/80 to-slate-900/40"></div>
            <div class="absolute inset-0 flex items-center">
                <div class="container mx-auto px-4">
                    <div class="max-w-2xl text-white">
                        <h1 class="text-5xl font-bold text-white mb-4">Productos y Servicios de Calidad</h1>
                        <p class="text-white/90 text-xl mb-6">Conecta con negocios verificados que ofrecen lo mejor para ti</p>
                        <button class="px-6 py-3 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition text-lg">
                            Explorar Ahora
                        </button>
                    </div>
        ...
        <div class="slide absolute inset-0 transition-opacity duration-500 opacity-0">
            <img src="https://images.unsplash.com/photo-1453614512568-c4024d13c247?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&w=1080" 
                 alt="Apoya el Comercio Local" 
                 class="w-full h-full object-cover">
            <div class="absolute inset-0 bg-gradient-to-r from-slate-900/80 to-slate-900/40"></div>
            <div class="absolute inset-0 flex items-center">
                <div class="container mx-auto px-4">
                    <div class="max-w-2xl text-white">
                        <h1 class="text-5xl font-bold text-white mb-4">Apoya el Comercio Local</h1>
                        <p class="text-white/90 text-xl mb-6">Fortalece tu comunidad comprando en negocios de tu zona</p>
                        <button class="px-6 py-3 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition text-lg">
                            Explorar Ahora
                        </button>
                    </div>
        ...
        <!-- Slider Controls -->
        <button onclick="changeSlide(-1)" class="absolute left-4 top-1/2 -translate-y-1/2 bg-white/20 hover:bg-white/30 backdrop-blur-sm p-3 rounded-full transition">
            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path>
            </svg>
        </button>
        <button onclick="changeSlide(1)" class="absolute right-4 top-1/2 -translate-y-1/2 bg-white/20 hover:bg-white/30 backdrop-blur-sm p-3 rounded-full transition">
            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="absolute bottom-6 left-1/2 -translate-x-1/2 flex gap-2">
            <button onclick="goToSlide(0)" class="dot w-2 h-2 rounded-full transition bg-white w-8"></button>
            <button onclick="goToSlide(1)" class="dot w-2 h-2 rounded-full transition bg-white/50"></button>
            <button onclick="goToSlide(2)" class="dot w-2 h-2 rounded-full transition bg-white/50"></button>
        </div>
    </div>
    ...
    <div class="bg-white py-12">
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div class="bg-white rounded-lg border border-slate-200 hover:shadow-lg transition cursor-pointer group">
                    <div class="p-6 text-center">
                        <div class="bg-orange-500 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition">
                ...
                <div class="bg-white rounded-lg border border-slate-200 hover:shadow-lg transition cursor-pointer group">
                    <div class="p-6 text-center">
                        <div class="bg-purple-500 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition">
                            <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-white rounded-lg border border-slate-200 hover:shadow-lg transition cursor-pointer group">
                    <div class="p-6 text-center">
                        <div class="bg-pink-500 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition">
                            <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-white rounded-lg border border-slate-200 hover:shadow-lg transition cursor-pointer group">
                    <div class="p-6 text-center">
                        <div class="bg-amber-600 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition">
                            <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-white rounded-lg border border-slate-200 hover:shadow-lg transition cursor-pointer group">
                    <div class="p-6 text-center">
                        <div class="bg-indigo-500 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition">
                            <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-white rounded-lg border border-slate-200 hover:shadow-lg transition cursor-pointer group">
                    <div class="p-6 text-center">
                        <div class="bg-green-500 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition">
                            <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
                            </svg>
                        </div>
                ...
                <div class="bg-white rounded-lg border border-slate-200 hover:shadow-lg transition cursor-pointer group">
                    <div class="p-6 text-center">
                        <div class="bg-rose-500 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition">
                            <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
